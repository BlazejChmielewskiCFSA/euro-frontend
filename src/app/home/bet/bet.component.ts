...
import { AddBetData } from 'src/app/core/models/auth.model';
import { AddBetForm } from 'src/app/core/models/forms.model';
...
export class BetComponent {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('showSnackbar')) {
      ...
      localStorage.removeItem('showSnackbar'); // Remove the flag after showing the snackbar
    }
  }
